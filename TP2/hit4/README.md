# Hit #4 y Aplicación Base — Consultas LogQL (Cookbook)

Este directorio contiene la aplicación de Scraping adaptada para emitir datos que responden a las 5 consultas requeridas en el Hit #4.
...
> **Aviso Hit #4**: El archivo `observability/queries/logql-cookbook.md` ha sido completamente completado y explicado con las 5 consultas LogQL requeridas en la consigna.
...
#### 📸 Consigna obligatoria (Hit #4): LogQL Cookbook Screenshots
Debes ejecutar **las 5 queries** documentadas en `observability/queries/logql-cookbook.md` dentro del panel *Explore* de Grafana (o en un panel creado temporalmente), y capturar el resultado.

Guarda los screenshots en la carpeta `observability/screenshots/` con estos nombres:
- `hit4-q1.png`
- `hit4-q2.png`
- `hit4-q3.png`
- `hit4-q4.png`
...
![Q1 Ejemplo](observability/screenshots/hit4-q1.png)
